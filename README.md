...
- Delivered **5+ full-stack apps** with responsive UIs and scalable back-end infrastructure
- Built cross-platform solutions with **Flutter**, **Django REST**, and **Next.js App Router**
...
![Ethereum](https://img.shields.io/badge/Web3-3C3C3D?style=flat-square&logo=ethereum&logoColor=white)
...
|---------|-------|-------------|------|
| 📚 **Idris Book Bank** | MERN | Community book banking system | [idrisbookbank.com](https://idrisbookbank.com) |
| 🎨 **Hunars** | Next.js · Django | Skills & craft learning platform | [hunars.com](https://hunars.com) |
