...
<FavouriteButton className="product-actions" onClick={() => addwishtlist()}>
    ...
    <Box p={2} textAlign="center">
      ...
      <Paragraph style={{ "lineHeight": "1.5em", "height": "3em", "overflow": "hidden" }}>{name}</Paragraph>
...
!cartItem?.qty ? (
  ...
  <FlexBox alignItems="center" mb={4.5} sx={{
    ...
    return (
      ...
      {stock=='0.00'?<StyledChip color="primary" size="small" label='Out of Stock' />:''}
  {
  isNewArrival==1?(
  <StyledChip1 color="primary" size="small" label='New Arrival' />
